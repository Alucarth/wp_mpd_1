...
if ( isset( $_GET['ld-pt'] ) &&  $_GET['ld-pt'] ) {
	$custom_sidebar = 'learndash_sidebar';
	if ( isset( $smof_data['ld-archive-sidebar'] ) && is_active_sidebar( $smof_data['ld-archive-sidebar'] ) ) {
		$custom_sidebar = $smof_data['ld-archive-sidebar'];
	}
}
if ( isset( $smof_data['teacher-category-custom-sidebar'] ) && get_post_type() == 'post-k-teacher' ) {
	$custom_sidebar = $smof_data['teacher-category-custom-sidebar'];
}
