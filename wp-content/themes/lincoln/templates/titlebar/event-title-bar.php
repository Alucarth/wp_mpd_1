...
// Check pre
if ( is_tax( 'k-event-category' ) || is_tax( 'k-event-tag' ) ) {
	$pre 		= 'event-category-';
	$single_pre = 'event_category_';
} else {
	$pre 		= 'event-';
	$single_pre = 'event_';
}
...
?>
	...
	<div class="k2t-title-bar event-title-bar <?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="<?php echo esc_attr( implode( '', $css ) ); ?>" <?php echo esc_attr($inline_attr); ?>>
			...
			<div class="container k2t-wrap">
				<h1 class="main-title" style="<?php echo esc_attr($titlebar_font_size . $titlebar_color); ?>">
					<?php
						...
						} elseif ( is_tax( 'k-event-category' ) || is_tax( 'k-event-tag' ) ) {
