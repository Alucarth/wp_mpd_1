<?php
/**
 * The template for displaying title and breadcrumb of course.
 *
 * @package Lincoln
 * @author  LunarTheme
...
// Check pre
if ( is_tax( 'k-course-category' ) || is_tax( 'k-course-tag' ) ) {
	$pre 		= 'course-category-';
	$single_pre = 'course_category_';
} else {
	$pre 		= 'course-';
	$single_pre = 'course_';
}
...
?>
	...
	<div class="k2t-title-bar course-title-bar <?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="<?php echo esc_attr( implode( '', $css ) ); ?>" <?php echo esc_attr($inline_attr); ?>>
			...
			<div class="container k2t-wrap">
				<h1 class="main-title" style="<?php echo esc_attr($titlebar_font_size . $titlebar_color); ?>">
					<?php
						...
						} elseif ( is_tax( 'k-course-category' ) || is_tax( 'k-course-tag' ) ) {
