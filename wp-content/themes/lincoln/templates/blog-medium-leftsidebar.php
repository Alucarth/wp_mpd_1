 ...
 * Template Name: Blog medium left sidebar
 */
...
get_header(); ?>
	...
	<div class="k2t-content left-sidebar b-medium <?php echo esc_attr($classes);?>">

		<div class="k2t-wrap">

			<main class="k2t-blog pagination-noborder" role="main">
