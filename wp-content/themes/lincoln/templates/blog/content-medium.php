<?php
/**
 * The template for displaying content medium image thumbnail.
 *
 * @package Lincoln
 * @author  LunarTheme
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'element post-item ' . $post_format . '-post' ); ?>>
				...
				<div class= "footer-content">
					<?php 
						if ( $smof_data['blog-readmore'] ) {
							echo '<a class="more-link btn-ripple" href="' . get_permalink() . '">'. __( 'Ver más', 'k2t' ) .'<i class="zmdi zmdi-chevron-right"></i></a>';
						}
					?>
