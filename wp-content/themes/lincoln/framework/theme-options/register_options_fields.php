...
$of_options[] = array( 'name' => esc_html__( 'Mobile Header', 'k2t' ),
	'type' => 'heading',
	'icon' => '<i class="zmdi zmdi-border-top"></i>',
);

$of_options[] = array( 'name' => esc_html__( 'Sticky main menu mobile', 'k2t' ),
	'type' => 'info',
	'std'  => esc_html__( 'Sticky main mobile menu', 'k2t' ),
);

// $of_options[] = array( 'name' => esc_html__( 'Sticky menu?', 'k2t' ),
// 	'id'   => 'mm_sticky',
// 	'type' => 'select',
// 	'options' => array(
// 		''       	 	 => esc_html__( 'None', 'k2t' ),
// 		'sticky'		 => esc_html__( 'Sticky main mobile menu', 'k2t' ),
// 		'smart_sticky'	 => esc_html__( 'Smart sticky main mobile menu', 'k2t' ),
// 	),
// 	'std'  => '',
// 	'desc' => esc_html__( 'Select mobile menu sticky', 'k2t' ),
// );


$of_options[] = array( 'name' => esc_html__( 'Top-section mobile menu', 'k2t' ),
	'type' => 'info',
	'std'  => esc_html__( 'Top section mobile menu', 'k2t' ),
);

$of_options[] = array( 'name' => esc_html__( 'Show/Hide top-section mobile menu', 'k2t' ),
	'id'   => 'show_mm_top',
	'type' => 'switch',
	'std'  => true,
	'k2t_logictic' => array(
		true => array( 'top_mm_desc','top_mm_social', 'top_mm_cart', 'top-section-color' ),
	),
);

$of_options[] = array( 'name'   => __( 'Background color', 'k2t' ),
	'id'   => 'top-section-color',
	'type' => 'color',
	'std'  => '',
);

$of_options[] = array( 'name'   => __( 'Text color', 'k2t' ),
	'id'   => 'top-section-text-color',
	'type' => 'color',
	'std'  => '',
);

$of_options[] = array( 'name' => esc_html__( 'Insert text to Top-left column of the mobile menu', 'k2t' ),
	'type' => 'textarea',
	'std'  => '',
	'id'   => 'top_mm_desc',
	'desc'   => '',
...
// $of_options[] = array( 'name' => esc_html__( 'Show/Hide Social Icon', 'k2t' ),
// 	'id'   => 'top_mm_social',
// 	'type' => 'switch',
// 	'std'  => true,
// );

$of_options[] = array( 'name' => esc_html__( 'Show/Hide Mini cart', 'k2t' ),
	'id'   => 'top_mm_cart',
	'type' => 'switch',
	'std'  => true,
);

$of_options[] = array( 'name' => esc_html__( 'Toggle mobile menu', 'k2t' ),
	'type' => 'info',
	'std'  => esc_html__( 'Toggle mobile menu', 'k2t' ),
);
// $of_options[] = array( 'name' => esc_html__( 'Show/Hide Wishlist icon', 'k2t' ),
// 	'id'   => 'toggle_mm_wl',
// 	'type' => 'switch',
// 	'std'  => true,
// );

$of_options[] = array( 'name' => esc_html__( 'Show/Hide login link', 'k2t' ),
	'id'   => 'toggle_mm_login',
	'type' => 'switch',
	'std'  => true,
);
...
if ( function_exists('is_plugin_active') && is_plugin_active( 'sfwd-lms/sfwd_lms.php') ) :
	...
	$of_options[] = array( 'name' => __( 'LearnDash Listing', 'k2t' ),
		'type' => 'info',
		'std'  => __( 'LearnDash Meta', 'k2t' ),
	);

	$of_options[] = array( 'name' => __( 'Show/Hide course ribbon text', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'sfwd-course-ribbon',
	);

	$of_options[] = array( 'name' => __( 'Show/Hide course category', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'sfwd-course-list-cat',
	);
	
	$of_options[] = array( 'name' => __( 'Show/Hide course date', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'sfwd-course-list-date',
	);


	$of_options[] = array( 'name' => __( 'Content or excerpt', 'k2t' ),
		'type'    => 'select',
		'id'      => 'sfwd-course-list-content',
		'options' => array (
			'excerpt' => __( 'Limit Words', 'k2t' ),
			'content' => __( 'Content', 'k2t' ) ),
		'std'  => 'excerpt',
		'desc' => __( 'Select display course content or limit words on course listing.', 'k2t' ),
		'k2t_logictic' => array(
			'excerpt' => array( 'sfwd-course-list-words' ),
			'content' => array()
		),
	);
	...
	$of_options[] = array( 'name' => __( 'Excerpt length (words)', 'k2t' ),
		...
		'min'  => 10,
		'max'  => 80,
		'id'   => 'sfwd-course-list-words',
	);

	$of_options[] = array( 'name' => __( 'Show/Hide Readmore', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'sfwd-course-list-readmore',
	);

	$of_options[] = array( 'name' => __( 'LearnDash Course archive', 'k2t' ),
		'type' => 'info',
		'std'  => __( 'LearnDash Meta', 'k2t' ),
	);

	$of_options[] = array(  'name' => __( 'LearnDash archive custom sidebar', 'k2t' ),
		'type' => 'text',
		'std'  => '',
		'id'   => 'ld-archive-sidebar',
		'desc' => 'Number only, If empty will get value from WP settings',
	);

	$of_options[] = array(  'name' => __( 'Number of courses to display', 'k2t' ),
		'type' => 'text',
		'std'  => '',
		'id'   => 'ld-archive-limit',
		'desc' => 'Number only, If empty will get value from WP settings',
	...
	$of_options[] = array( 'name' => __( 'Show/Hide category', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'ld-archive-cat',
	);

	$of_options[] = array( 'name' => __( 'Show/Hide button link', 'k2t' ),
		'type' => 'switch',
		'std'  => true,
		'id'   => 'ld-archive-link',
	);
...
$of_options[] = array( 'name' => __( 'Get Related Event By', 'k2t' ),
	'type' => 'select',
	'options' => array(
		'k-event-category' => __( 'Category', 'k2t' ),
		'k-event-tag'  => __( 'Tag', 'k2t' ),
	),
	'std' => 'k-event-category',
	'id'  => 'event-related-by',
);
$of_options[] = array( 'name' => __( 'Show/Hide Only UpComming Events', 'k2t' ),
	'type' => 'switch',
	'std'  => false,
	'id'   => 'event-related-upcomming-only',
	'desc' => __( '', 'k2t' ),
);
...
$of_options[] = array( 'name' => __( 'Teacher Category', 'k2t' ),
	'type' => 'info',
	'std'  => __( 'Teacher Category', 'k2t' ),
);
$of_options[] = array( 'name' => __( 'Layout', 'k2t' ),
	'type' => 'select',
	'options' => array(
	...
	'std' => 'right_sidebar',
	'id'  => 'teacher-category-layout',
);
$of_options[] = array( 'name' => __( 'Style', 'k2t' ),
	'type' => 'select',
	'options' => array(
		'style-classic'    => __( 'Classic', 'k2t' ),
		'style-shadow-box' => __( 'Shadow Box', 'k2t' ),
	),
	'std' => 'style-shadow-box',
	'id'  => 'teacher-category-style',
);
$of_options[] = array( 'name' => __( 'Columns', 'k2t' ),
	'type' => 'select',
	'options' => array(
	...
	'std' => 'columns-3',
	'id'  => 'teacher-category-columns',
);
$of_options[] = array( 'name' => __( 'Show/Hide excerpt', 'k2t' ),
	'type' => 'select',
	'options' => array(
		'show' => __( 'Show', 'k2t' ),
		'hide' => __( 'Hide', 'k2t' ),
...
$of_options[] = array( 'name' => __( 'Excerpt length', 'k2t' ),
	...
	'min'  => 10,
	'max'  => 30,
	'id'   => 'teacher-category-excerpt-length',
);
$of_options[] = array( 'name' => __( 'Teacher Category custom sidebar', 'k2t' ),
	'type' => 'text',
	'std'  => '',
	'id'   => 'teacher-category-custom-sidebar',
	'desc'   => '',
);
...
$of_options[] = array( 'name' => __( 'Subscribe Button target', 'k2t' ),
	'type' => 'select',
	'options' => array(
		'_self' => 'Self',
		'_blank'  => 'New Tab',
