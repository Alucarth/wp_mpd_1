...
class lincoln_welcome {
	...
	protected static function install_demos_html() { 
		...
		<div id="demos" class="tab-pane active" role="tabpanel"> 
			...
			<div class="welcome-panel panel-small">
				...
				<p><span style="color: red">Note</span>: If 1 click sample data do not work. Please install recommend plugin "Import Demo Content" then go to Tools > Import demo to try other way to install our demo.</p>
			</div>
		...
		<?php 
		 /* format setting outer wrapper */
			...
			do_action( 'welcome_after_sample_data' );
	...
	protected static function install_plugins_html() {
		...
		$plugins = array(
			...
			array(
				'name'     => esc_html__( 'Import Demo Content', 'k2t' ),
				'slug'     => 'z-import-demo',
				'required' => false,
