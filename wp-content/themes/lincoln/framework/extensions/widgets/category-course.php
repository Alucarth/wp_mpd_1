...
add_action('widgets_init', 'k2t_category_course_load_widgets');
function k2t_category_course_load_widgets()
{
    register_widget('WP_Widget_Categories_Course');
}

class WP_Widget_Categories_Course extends WP_Widget
{

    public function __construct()
    {
        $widget_ops = array('classname' => 'widget_categories widget_categories_course', 'description' => __("A list or dropdown of categories.", 'k2t'));
        parent::__construct('categories_course', __('Categories Course', 'k2t'), $widget_ops);
    }
