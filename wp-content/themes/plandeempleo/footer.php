...
?>
	...
	<?php if ( is_active_sidebar( 'widget_prefooter' ) ) : ?>
	<div id="sidebar-prefooter">
		<div class="wrapper-section-prefooter k2t-wrap">
			<div class="k2t-row">
				<div class="col-12">
					<div class="prefooter-content">					
						<?php dynamic_sidebar( 'widget_prefooter' ); ?>
					</div>
				</div>
			</div>
		</div>
...
<?php if ( ! is_404() ) : ?>
	...
	<div class="k2t-searchbox">
		...
		<form class="searchform" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" >
			<input type="text" value="<?php echo esc_url( get_search_query() ); ?>" name="s" id="s" placeholder="<?php esc_html_e('Buscar...','k2t'); ?>" />
...
?>
	<!-- Floating Button -->
	<!--
	<a href="http://www.plandeempleo.bo:8080/" class="float" target="_blank">
		<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/plandeempleo/assets/img/logo_orientacion_vocacional.png" alt="" class="img-complete" />
		<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/plandeempleo/assets/img/logo_orientacion_vocacional_small.png" alt="" class="img-small" />
	</a>
	-->
	<!-- End Floating Button -->
<?php
