...
<article class="view view-first <?php echo esc_attr( $post_classes );?>">
    ...
    <?php endif;?>
    <div class="mask">
        <div class="pf-lightbox"><a href="<?php echo esc_url( $post_thumb_url );?>" class="k2t-popup-link"><?php _e( '+', 'k2t-gallery' ); ?></a></div>
    </div>
</article><!-- .article -->