		...
		<?php if( $nav == 'pagination_lite') : ?>
			<div class="k2t-pagination-lite">
				<div class="prev-post btn-ripple">
					<?php previous_posts_link(__( '<i class="zmdi zmdi-long-arrow-left"></i>Previous', 'k2t-event' )); ?>
				</div>
				<div class="next-post btn-ripple">
					<?php next_posts_link(__( 'Next<i class="zmdi zmdi-long-arrow-right"></i>', 'k2t-event' )); ?>
				</div>
			</div>
		<?php else : ?>
			<div class="k2t-navigation">
				...
				echo '' . paginate_links(
					array(
						...
						'total'     => $max,
						'type'      => 'list',
						'prev_text' => __( '<i class="zmdi zmdi-long-arrow-left"></i>', 'k2t-event' ),
						'next_text' => __( '<i class="zmdi zmdi-long-arrow-right"></i>', 'k2t-event' )
					)
				) . ' ';
				?>
			</div> 
