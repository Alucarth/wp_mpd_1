...
function k2t_array_values_deep($elem, $field = null){
	$holder = array();
	k2t_array_values_deep_($elem, $field, null, $holder);
	return $holder;
}

function k2t_array_values_deep_($elem, $field, $pre_field, &$holder){
	if( !is_array($elem) && !is_object($elem) ){
		...
		foreach($elem as $k => $e){
			k2t_array_values_deep_($e, $field, $k, $holder);
		}
	}
