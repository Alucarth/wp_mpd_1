...
function k_event_load_plugin_textdomain() {
  load_plugin_textdomain( 'k2t-event', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
...
function k2t_event_add_new_image_size() {
    ...
    add_image_size( 'thumb_m_414x414', 414, 414, true ); // event default listing
