			...
			<div class="post-inner">
						...
						<div class= "footer-content clearfix">
							<?php 
								if ( $smof_data['blog-readmore'] ) {
									echo '<a class="more-link btn-ripple" href="' . get_permalink() . '">'. __( 'Ver más', 'k2t-shortcodes' ) .'<i class="zmdi zmdi-chevron-right"></i></a>';
								}
							?>
				...
				<?php if ( 'quote' == $post_format ) : ?>
					...
					<div class= "footer-content clearfix">
						<?php 
							if ( $smof_data['blog-readmore'] ) {
								echo '<a class="more-link btn-ripple" href="' . get_permalink() . '">'. __( 'Read more', 'k2t-shortcodes' ) .'<i class="zmdi zmdi-chevron-right"></i></a>';
							}
						?>
						<?php if ( $smof_data['blog-number-comment'] ) :?>
							<span class="entry-comment"><i class="zmdi zmdi-comment-alt-text"></i><a href="<?php comments_link(); ?>"><?php comments_number( '0', '1', '%' ); ?></a></span>
